...
$bericht = "Voornaam: ".$_POST['first_name'].
    ...
    "<br><br>Bericht:<br>".$_POST['comments'];

$mailer = Swift_Mailer::newInstance($transport);

// Create a message
$message = Swift_Message::newInstance($_POST['onderwerp'])
    ->setFrom(array($_POST['email'] => 'Via Contact Formulier'))
    ->setTo(array('1026008@idcollege.nl'))
